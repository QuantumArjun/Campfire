...
class Input extends React.Component {
  constructor(props) { //props contains everything that was  passed into this component from lobby
    ...
    this.state = {
      message: "",
      needWords: props.lowerwordlimit,
      maxWords:  props.higherwordlimit,
      wordCount: "",
      limWordsMax: "",
      limWordsMin: ""
    };
...
// const Input = ({ setMessage, sendMessage, message, higherwordlimit, lowerwordlimit }) => (
//   // console.log(higherwordlimit, lowerwordlimit),
//   <form className="form">
//     <input
//       className="input"
//       type="text"
